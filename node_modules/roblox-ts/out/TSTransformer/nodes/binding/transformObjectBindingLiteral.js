...
function transformObjectBindingLiteral(state, bindingLiteral, parentId, accessType) {
    for (const property of bindingLiteral.properties) {
        if (typescript_1.default.isShorthandPropertyAssignment(property)) {
            ...
            const value = (0, objectAccessor_1.objectAccessor)(state, parentId, accessType, name);
            ...
            (0, assert_1.assert)(LuauAST_1.default.isAnyIdentifier(id));
            ...
            if (typescript_1.default.isIdentifier(init) || typescript_1.default.isElementAccessExpression(init) || typescript_1.default.isPropertyAccessExpression(init)) {
                ...
                (0, transformArrayBindingLiteral_1.transformArrayBindingLiteral)(state, init, id, (0, getSubType_1.getSubType)(state, accessType, name.text));
            }
                ...
                (0, assert_1.assert)(typescript_1.default.isIdentifier(name));
                transformObjectBindingLiteral(state, init, id, (0, getSubType_1.getSubType)(state, accessType, name.text));
            }
            else {
