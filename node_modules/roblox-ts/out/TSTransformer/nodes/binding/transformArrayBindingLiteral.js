...
function transformArrayBindingLiteral(state, bindingLiteral, parentId, accessType) {
    ...
    const accessor = (0, getAccessorForBindingType_1.getAccessorForBindingType)(state, bindingLiteral, accessType);
    for (let element of bindingLiteral.elements) {
        if (typescript_1.default.isOmittedExpression(element)) {
            ...
            if (typescript_1.default.isIdentifier(element) ||
                ...
                transformArrayBindingLiteral(state, element, id, (0, getSubType_1.getSubType)(state, accessType, index));
            }
