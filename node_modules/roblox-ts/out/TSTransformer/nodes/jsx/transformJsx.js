...
function transformJsx(state, node, tagName, attributes, children) {
    ...
    const tagNameExp = !isFragment ? (0, transformJsxTagName_1.transformJsxTagName)(state, tagName) : LuauAST_1.default.nil();
    ...
    let result = LuauAST_1.default.call(isFragment ? (0, createRoactIndex_1.createRoactIndex)("createFragment") : (0, createRoactIndex_1.createRoactIndex)("createElement"), args);
    if (!typescript_1.default.isJsxElement(node.parent)) {
        ...
        if (keyInitializer) {
            ...
            result = LuauAST_1.default.call((0, createRoactIndex_1.createRoactIndex)("createFragment"), [LuauAST_1.default.map([[key, result]])]);
        }
    }
    return result;
}
