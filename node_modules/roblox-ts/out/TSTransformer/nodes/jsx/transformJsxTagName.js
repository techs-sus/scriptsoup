...
function transformJsxTagNameExpression(state, node) {
    if (typescript_1.default.isIdentifier(node)) {
        ...
        if (symbol) {
            ...
            if (className !== undefined) {
                return LuauAST_1.default.string(className);
            }
        }
    }
    if (typescript_1.default.isPropertyAccessExpression(node)) {
        ...
        return LuauAST_1.default.property((0, convertToIndexableExpression_1.convertToIndexableExpression)((0, transformExpression_1.transformExpression)(state, node.expression)), node.name.text);
    }
    else {
