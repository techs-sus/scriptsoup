...
function createJsxAddAmbiguousChildren(id, amtSinceUpdate, lengthId, expression) {
    ...
    return LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
        ...
        statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.IfStatement, {
            condition: (0, createTypeCheck_1.createTypeCheck)(keyId, LuauAST_1.default.strings.number),
            statements: LuauAST_1.default.list.make(createJsxAddNumericChild(id, (0, offset_1.offset)(lengthId, amtSinceUpdate), keyId, valueId)),
...
function createJsxAddChild(state, id, amtSinceUpdate, lengthId, expression, type) {
    ...
    if (isPossiblyArray || isPossiblyMap) {
        ...
        if (isPossiblyElement) {
            (0, assert_1.assert)(LuauAST_1.default.isAnyIdentifier(expression));
    ...
    if (isPossiblyUndefinedOrFalse || isPossiblyTrue) {
        if (isPossiblyElement || isPossiblyArray || isPossiblyMap) {
            let condition;
            if (isPossiblyTrue) {
                condition = (0, createTypeCheck_1.createTypeCheck)(expression, LuauAST_1.default.strings.table);
            }
            else {
        ...
        if (typescript_1.default.isJsxExpression(child)) {
            ...
            if (innerExp) {
                ...
                if (child.dotDotDotToken) {
                    disableInline();
                    (0, assert_1.assert)(LuauAST_1.default.isAnyIdentifier(childrenPtr.value));
