...
function transformWritableExpression(state, node, readAfterWrite) {
    ...
    if (typescript_1.default.isPropertyAccessExpression(node)) {
        ...
        return LuauAST_1.default.property(readAfterWrite ? state.pushToVarIfComplex(expression, "exp") : (0, convertToIndexableExpression_1.convertToIndexableExpression)(expression), node.name.text);
    }
        ...
        (0, assert_1.assert)(LuauAST_1.default.isWritableExpression(transformed));
        return transformed;
    }
}
