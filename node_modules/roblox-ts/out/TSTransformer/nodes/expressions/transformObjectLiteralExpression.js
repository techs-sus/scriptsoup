...
function transformPropertyAssignment(state, ptr, name, initializer) {
    let [left, leftPrereqs] = state.capture(() => (0, transformObjectKey_1.transformObjectKey)(state, name));
...
function transformSpreadAssignment(state, ptr, property) {
    ...
    const isPossiblyNonObject = !(0, types_1.isDefinitelyType)(type, types_1.isObjectType);
    ...
    if (isPossiblyNonObject) {
        statement = LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.IfStatement, {
            condition: (0, createTypeCheck_1.createTypeCheck)(spreadExp, LuauAST_1.default.strings.table),
