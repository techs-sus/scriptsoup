...
function transformPropertyAccessExpressionInner(state, node, expression, name) {
    ...
    if (typescript_1.default.isDeleteExpression((0, traversal_1.skipUpwards)(node).parent)) {
        state.prereq(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.Assignment, {
            left: LuauAST_1.default.property((0, convertToIndexableExpression_1.convertToIndexableExpression)(expression), name),
            operator: "=",
            right: LuauAST_1.default.nil(),
        }));
        return LuauAST_1.default.nil();
    }
    return LuauAST_1.default.property((0, convertToIndexableExpression_1.convertToIndexableExpression)(expression), name);
}
