...
const transformAsExpression_1 = require("./transformAsExpression");
...
const transformNonNullExpression_1 = require("./transformNonNullExpression");
...
const transformTypeAssertion_1 = require("./transformTypeAssertion");
...
const NO_EMIT = () => LuauAST_1.default.nil();
...
const TRANSFORMER_BY_KIND = new Map([
    ...
    [typescript_1.default.SyntaxKind.AsExpression, transformAsExpression_1.transformAsExpression],
    ...
    [typescript_1.default.SyntaxKind.NonNullExpression, transformNonNullExpression_1.transformNonNullExpression],
    [typescript_1.default.SyntaxKind.NoSubstitutionTemplateLiteral, transformStringLiteral_1.transformStringLiteral],
    ...
    [typescript_1.default.SyntaxKind.TypeAssertionExpression, transformTypeAssertion_1.transformTypeAssertion],
