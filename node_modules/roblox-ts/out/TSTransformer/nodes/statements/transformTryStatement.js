...
function transformCatchClause(state, node) {
    ...
    if (node.variableDeclaration) {
        LuauAST_1.default.list.push(parameters, (0, transformBindingName_1.transformBindingName)(state, node.variableDeclaration.name, statements));
    }
    LuauAST_1.default.list.pushList(statements, (0, transformStatementList_1.transformStatementList)(state, node.block.statements));
...
function transformIntoTryCall(state, node, exitTypeId, returnsId, tryUses) {
    ...
    tryCallArgs.push(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.FunctionExpression, {
        ...
        hasDotDotDot: false,
        statements: (0, transformStatementList_1.transformStatementList)(state, node.tryBlock.statements),
    }));
    if (node.catchClause) {
    ...
    if (node.finallyBlock) {
        tryCallArgs.push(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.FunctionExpression, {
            parameters: LuauAST_1.default.list.make(),
            hasDotDotDot: false,
            statements: (0, transformStatementList_1.transformStatementList)(state, node.finallyBlock.statements),
        }));
    }
