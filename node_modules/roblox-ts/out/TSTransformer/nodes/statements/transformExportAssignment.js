...
function transformExportEquals(state, node) {
    ...
    if (finalStatement === node) {
        return LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ReturnStatement, { expression: (0, transformExpression_1.transformExpression)(state, node.expression) }));
    }
    else {
...
function transformExportAssignment(state, node) {
    ...
    if (symbol && (0, isDefinedAsLet_1.isDefinedAsLet)(state, symbol)) {
