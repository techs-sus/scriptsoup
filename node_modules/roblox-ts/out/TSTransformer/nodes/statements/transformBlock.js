...
function transformBlock(state, node) {
    return LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.DoStatement, {
        statements: (0, transformStatementList_1.transformStatementList)(state, node.statements),
    }));
}
