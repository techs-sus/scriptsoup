        ...
        if (typescript_1.default.isLogicalOrCoalescingAssignmentExpression(expression)) {
            ...
            if (operator !== undefined) {
                return LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.Assignment, {
                    left: writable,
                    operator,
                    right: operator === "..=" && !(0, types_1.isDefinitelyType)(valueType, types_1.isStringType)
                        ? LuauAST_1.default.call(LuauAST_1.default.globals.tostring, [value])
                        : value,
                }));
            }
            else {
                return LuauAST_1.default.list.make((0, assignment_1.createCompoundAssignmentStatement)(state, expression, writable, writableType, readable, operatorKind, value, valueType));
            }
        }
    }
