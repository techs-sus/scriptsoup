...
function transformDoStatement(state, { expression, statement }) {
    const statements = (0, transformStatementList_1.transformStatementList)(state, (0, getStatements_1.getStatements)(statement));
    ...
    const repeatStatements = LuauAST_1.default.list.make();
    LuauAST_1.default.list.push(repeatStatements, LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.DoStatement, {
        statements,
    }));
    LuauAST_1.default.list.pushList(repeatStatements, conditionPrereqs);
    return LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.RepeatStatement, {
        ...
        condition: conditionIsInvertedInLuau ? LuauAST_1.default.unary("not", condition) : condition,
    }));
}
