...
function addFinalizers(list, node, finalizers) {
    (0, assert_1.assert)(!LuauAST_1.default.list.isEmpty(list));
...
function transformForStatement(state, node) {
    ...
    LuauAST_1.default.list.pushList(whileStatements, (0, transformStatementList_1.transformStatementList)(state, (0, getStatements_1.getStatements)(statement)));
