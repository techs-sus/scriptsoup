...
function isDeclarationOfNamespace(declaration) {
    var _a;
    if ((_a = declaration.modifiers) === null || _a === void 0 ? void 0 : _a.some(v => v.kind === typescript_1.default.SyntaxKind.DeclareKeyword)) {
        return false;
    }
    ...
    for (const declaration of (_a = symbol.getDeclarations()) !== null && _a !== void 0 ? _a : []) {
        ...
        if (statement) {
            ...
            if (typescript_1.default.isInterfaceDeclaration(statement))
                continue;
            if ((_b = statement.modifiers) === null || _b === void 0 ? void 0 : _b.some(v => v.kind === typescript_1.default.SyntaxKind.DeclareKeyword))
                continue;
            return statement;
        }
    }
    ...
    if (typescript_1.default.isModuleBlock(body)) {
        ...
        if (moduleExports.length > 0) {
            for (const exportSymbol of moduleExports) {
                ...
                if ((0, isSymbolOfValue_1.isSymbolOfValue)(originalSymbol) && !(0, isDefinedAsLet_1.isDefinedAsLet)(state, originalSymbol)) {
        ...
        LuauAST_1.default.list.pushList(doStatements, (0, transformStatementList_1.transformStatementList)(state, body.statements, {
            id: containerId,
            mapping: exportsMap,
        }));
    }
