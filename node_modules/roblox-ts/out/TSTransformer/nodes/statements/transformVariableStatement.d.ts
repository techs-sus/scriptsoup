...
export declare function transformVariable(state: TransformState, identifier: ts.Identifier, right?: luau.Expression): [value: luau.AnyIdentifier | luau.PropertyAccessExpression, prereqs: luau.List<luau.Statement<keyof luau.StatementByKind>>];
