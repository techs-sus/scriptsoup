...
function transformFunctionDeclaration(state, node) {
    ...
    const name = node.name ? (0, transformIdentifier_1.transformIdentifierDefined)(state, node.name) : LuauAST_1.default.id("default");
