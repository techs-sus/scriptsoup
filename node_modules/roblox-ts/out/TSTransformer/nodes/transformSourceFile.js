    ...
    if (!state.hasExportEquals) {
        for (const exportSymbol of state.getModuleExports(symbol)) {
            ...
            if (!(0, isSymbolOfValue_1.isSymbolOfValue)(originalSymbol))
                continue;
            if ((0, isDefinedAsLet_1.isDefinedAsLet)(state, originalSymbol)) {
            ...
            if (originalSymbol.valueDeclaration) {
                ...
                if ((_a = statement === null || statement === void 0 ? void 0 : statement.modifiers) === null || _a === void 0 ? void 0 : _a.some(v => v.kind === typescript_1.default.SyntaxKind.DeclareKeyword)) {
                    continue;
                }
            }
...
function transformSourceFile(state, node) {
    ...
    const statements = (0, transformStatementList_1.transformStatementList)(state, node.statements);
