...
function argumentsWithDefaults(state, args, defaults) {
    for (let i = 0; i < args.length; i++) {
        if (!LuauAST_1.default.isSimplePrimitive(args[i])) {
...
const READONLY_ARRAY_METHODS = {
    ...
    indexOf: (state, node, expression, args) => {
        ...
        return (0, offset_1.offset)(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.BinaryExpression, {
    ...
    every: makeEveryMethod(LuauAST_1.default.globals.ipairs, (keyId, valueId, expression) => [
        valueId,
        (0, offset_1.offset)(keyId, -1),
        expression,
    ]),
    some: makeSomeMethod(LuauAST_1.default.globals.ipairs, (keyId, valueId, expression) => [valueId, (0, offset_1.offset)(keyId, -1), expression]),
    forEach: (state, node, expression, args) => {
        ...
        state.prereq(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
            ...
            statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.CallStatement, {
                expression: LuauAST_1.default.call(callbackId, [valueId, (0, offset_1.offset)(keyId, -1), expression]),
            })),
        }));
    ...
    map: (state, node, expression, args) => {
        ...
        state.prereq(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
            ...
            statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.Assignment, {
                ...
                operator: "=",
                right: LuauAST_1.default.call(callbackId, [valueId, (0, offset_1.offset)(keyId, -1), expression]),
            })),
        }));
        return newValueId;
    },
        ...
        state.prereq(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
            ...
            statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.IfStatement, {
                condition: LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.BinaryExpression, {
                    left: LuauAST_1.default.call(callbackId, [valueId, (0, offset_1.offset)(keyId, -1), expression]),
                    operator: "==",
    ...
    find: (state, node, expression, args) => {
        ...
        state.prereq(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
            ...
            statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.IfStatement, {
                condition: LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.BinaryExpression, {
                    left: LuauAST_1.default.call(callbackId, [valueId, (0, offset_1.offset)(loopId, -1), expression]),
                    operator: "==",
                    right: LuauAST_1.default.bool(true),
                }),
                statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.Assignment, {
...
const ARRAY_METHODS = {
    push: (state, node, expression, args) => {
        ...
        expression = state.pushToVarIfComplex(expression, (0, valueToIdStr_1.valueToIdStr)(expression) || "exp");
        args = args.map((arg, i) => state.pushToVarIfComplex(arg, (0, valueToIdStr_1.valueToIdStr)(arg) || `arg${i}`));
    ...
    insert: (state, node, expression, args) => {
        return LuauAST_1.default.call(LuauAST_1.default.globals.table.insert, [expression, (0, offset_1.offset)(args[0], 1), args[1]]);
    },
    remove: (state, node, expression, args) => LuauAST_1.default.call(LuauAST_1.default.globals.table.remove, [expression, (0, offset_1.offset)(args[0], 1)]),
...
const READONLY_SET_MAP_SHARED_METHODS = {
    ...
    size: (state, node, expression) => {
        ...
        state.prereq(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
            ids: LuauAST_1.default.list.make(LuauAST_1.default.tempId()),
            expression: LuauAST_1.default.call(LuauAST_1.default.globals.pairs, [expression]),
            statements: LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.Assignment, {
                left: sizeId,
                operator: "+=",
