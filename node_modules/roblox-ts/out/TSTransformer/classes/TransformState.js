...
class TransformState {
    ...
    debugRender(node) {
        ...
        (0, solveTempIds_1.solveTempIds)(state, node);
        return (0, LuauRenderer_1.render)(state, node);
    }
    debugRenderList(list) {
        const state = new LuauRenderer_1.RenderState();
        (0, solveTempIds_1.solveTempIds)(state, list);
        return (0, LuauRenderer_1.renderStatements)(state, list);
    }
    pushTryUsesStack() {
        const tryUses = {
            usesReturn: false,
    ...
    getLeadingComments(node) {
        ...
        return LuauAST_1.default.list.make(...commentRanges.map(commentRange => LuauAST_1.default.comment(this.sourceFileText.substring(commentRange.pos + 2, commentRange.kind === typescript_1.default.SyntaxKind.SingleLineCommentTrivia
            ? commentRange.end
            : commentRange.end - 2))));
    }
    ...
    noPrereqs(callback) {
        ...
        (0, assert_1.assert)(LuauAST_1.default.list.isEmpty(statements));
        return expression;
    }
    getType(node) {
            ...
            if (this.projectType === constants_1.ProjectType.Game) {
                ...
                return LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.VariableDeclaration, {
                    ...
                    right: LuauAST_1.default.call(LuauAST_1.default.globals.require, [
                        (0, expressionChain_1.propertyAccessExpressionChain)(LuauAST_1.default.globals.script, RojoResolver_1.RojoResolver.relative(rbxPath, this.runtimeLibRbxPath).map(v => v === RojoResolver_1.RbxPathParent ? constants_1.PARENT_FIELD : v)),
                    ]),
                });
            }
        }
