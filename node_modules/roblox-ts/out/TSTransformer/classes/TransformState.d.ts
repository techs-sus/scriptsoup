...
export declare class TransformState {
    ...
    readonly prereqStatementsStack: luau.List<luau.Statement<keyof luau.StatementByKind>>[];
    prereq(statement: luau.Statement): void;
    prereqList(statements: luau.List<luau.Statement>): void;
    pushPrereqStatementsStack(): luau.List<luau.Statement<keyof luau.StatementByKind>>;
    popPrereqStatementsStack(): luau.List<luau.Statement<keyof luau.StatementByKind>>;
    getLeadingComments(node: ts.Node): luau.List<luau.Comment>;
    capturePrereqs(callback: () => void): luau.List<luau.Statement<keyof luau.StatementByKind>>;
    capture<T>(callback: () => T): [value: T, prereqs: luau.List<luau.Statement>];
    noPrereqs(callback: () => luau.Expression): luau.Expression<keyof luau.ExpressionByKind>;
    ...
    getOriginalSymbol(node: ts.Node): ts.Symbol | undefined;
    usesRuntimeLib: boolean;
    TS(node: ts.Node, name: string): luau.PropertyAccessExpression;
    checkJsxFactory(node: ts.Node): void;
    checkJsxFragmentFactory(node: ts.Node): void;
