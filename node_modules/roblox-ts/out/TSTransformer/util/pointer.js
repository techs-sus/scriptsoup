...
function createMapPointer(name) {
    return { name, value: LuauAST_1.default.map() };
}
exports.createMapPointer = createMapPointer;
function createArrayPointer(name) {
    return { name, value: LuauAST_1.default.array() };
}
exports.createArrayPointer = createArrayPointer;
function createMixedTablePointer(name) {
    return { name, value: LuauAST_1.default.mixedTable() };
}
