...
function getRelativeImport(sourceRbxPath, moduleRbxPath) {
    ...
    const pathExpressions = [(0, expressionChain_1.propertyAccessExpressionChain)(LuauAST_1.default.globals.script, path)];
...
function getNodeModulesImport(state, moduleSpecifier, moduleFilePath) {
    var _a;
    const moduleOutPath = state.pathTranslator.getImportPath((_a = state.nodeModulesPathMapping.get((0, getCanonicalFileName_1.getCanonicalFileName)(path_1.default.normalize(moduleFilePath)))) !== null && _a !== void 0 ? _a : moduleFilePath, true);
    ...
    (0, assert_1.assert)(moduleScope && typeof moduleScope === "string");
    ...
    (0, assert_1.assert)(moduleName && typeof moduleName === "string");
    ...
    return (0, expressionChain_1.propertyAccessExpressionChain)(LuauAST_1.default.call(state.TS(moduleSpecifier.parent, "getModule"), [
...
function createImportExpression(state, sourceFile, moduleSpecifier) {
    const moduleFile = (0, getSourceFileFromModuleSpecifier_1.getSourceFileFromModuleSpecifier)(state.typeChecker, moduleSpecifier);
    if (!moduleFile) {
        DiagnosticService_1.DiagnosticService.addDiagnostic(diagnostics_1.errors.noModuleSpecifierFile(moduleSpecifier));
        return LuauAST_1.default.tempId();
    }
