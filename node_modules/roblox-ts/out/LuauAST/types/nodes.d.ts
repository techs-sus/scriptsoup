...
export interface IndexableExpression<T extends keyof luau.IndexableExpressionByKind = keyof luau.IndexableExpressionByKind> extends luau.Node<T> {
}
...
export declare type AnyIdentifier = luau.Identifier | luau.TemporaryIdentifier;
export declare type WritableExpression = luau.AnyIdentifier | luau.PropertyAccessExpression | luau.ComputedIndexExpression;
export declare type SimpleTypes = luau.Identifier | luau.TemporaryIdentifier | luau.NilLiteral | luau.TrueLiteral | luau.FalseLiteral | luau.NumberLiteral | luau.StringLiteral;
export declare type ExpressionWithPrecedence = luau.IfExpression | luau.UnaryExpression | luau.BinaryExpression;
