...
declare type AllowedFieldTypes = luau.Node | luau.List<luau.Node> | boolean | number | string | undefined;
declare type FilterProps<T, U> = {
    [K in keyof T]: T[K] extends U ? T[K] : never;
};
declare type FilteredNodeByKind<T extends keyof luau.NodeByKind> = FilterProps<luau.NodeByKind[T], AllowedFieldTypes>;
