...
export declare const isSimple: (node: luau.Node) => node is luau.Identifier | luau.TemporaryIdentifier | luau.NilLiteral | luau.TrueLiteral | luau.FalseLiteral | luau.NumberLiteral | luau.StringLiteral;
export declare const isSimplePrimitive: (node: luau.Node) => node is luau.NilLiteral | luau.TrueLiteral | luau.FalseLiteral | luau.NumberLiteral | luau.StringLiteral;
export declare const isTable: (node: luau.Node) => node is luau.Array | luau.Map | luau.Set;
...
export declare const isExpressionWithPrecedence: (node: luau.Node) => node is luau.IfExpression | luau.UnaryExpression | luau.BinaryExpression;
