...
async function init(argv, mode) {
    ...
    if (mode === InitMode.None) {
        mode = (await (0, prompts_1.default)({
            type: "select",
            name: "template",
    ...
    const packageManagerExistance = {
        ...
        [PackageManager.PNPM]: (await (0, lookpath_1.lookpath)("pnpm")) ? true : false,
        [PackageManager.Yarn]: (await (0, lookpath_1.lookpath)("yarn")) ? true : false,
    };
