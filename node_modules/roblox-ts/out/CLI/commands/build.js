...
module.exports = typescript_1.default.identity({
    ...
    handler: async (argv) => {
        try {
            ...
            const data = (0, createProjectData_1.createProjectData)(tsConfigPath, projectOptions, argv);
            if (argv.watch) {
                (0, setupProjectWatchProgram_1.setupProjectWatchProgram)(data, argv.usePolling);
            }
            else {
