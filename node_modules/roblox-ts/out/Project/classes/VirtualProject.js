...
class VirtualProject {
    constructor() {
        ...
        (0, validateCompilerOptions_1.validateCompilerOptions)(this.compilerOptions, this.data.nodeModulesPath);
    ...
    compileSource(source) {
        ...
        const services = (0, createTransformServices_1.createTransformServices)(this.program, this.typeChecker, this.data);
        ...
        diagnostics.push(...(0, getCustomPreEmitDiagnostics_1.getCustomPreEmitDiagnostics)(sourceFile));
        ...
        if ((0, hasErrors_1.hasErrors)(diagnostics))
            throw new DiagnosticError_1.DiagnosticError(diagnostics);
        const luaSource = (0, LuauRenderer_1.renderAST)(luaAST);
        return luaSource;
    }
